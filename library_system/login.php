...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT username, password FROM lms_adminn WHERE username = ?";
	...
	<div class="content">
		<div class="banner">
			<div >
				...
				<br>
			<a href="./login.php">
			<span id="spanadmin">Admin Login</span>
			</a>
			<span id="spann">/</span>
			<a href="./index.php">
			...
			<br>
			<br><br>
			<h3>This is the Admin Login Form .</h3>
			
			<h3>Only Admins can access.</h3>
		</div>
       
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
		<div class="form">
			<img src="https://e7.pngegg.com/pngimages/688/1006/png-clipart-thor-lego-marvel-s-avengers-lego-marvel-super-heroes-lego-minifigure-thor-thor-lego-marvel-s-avengers.png" alt="profile">
			<br>
