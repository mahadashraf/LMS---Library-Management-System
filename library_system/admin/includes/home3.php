...
<div class="modal fade" id="studentAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Location Rack</h5>
        ...
        <form id="saveStudent">
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="">Location Rack Name</label>
                    <input type="text" name="location_rack_name" class="form-control" />
                </div>
                <div class="mb-3">
                    <label for="">Location Rack Status</label>
                    <input type="text" name="location_rack_status" class="form-control" />
                </div>
                <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary">Save Location Rack</button>
            </div>
        </form>
        </div>
    </div>
...
<div class="modal fade" id="studentEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Location Rack</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form id="updateStudent">
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="">Location Rack Status</label>
                    <input type="text" name="location_rack_status" id="location_rack_status" class="form-control" />
                </div>
                <!-- <div class="mb-3">
                    <label for="">Created On</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary">Update Location Rack</button>
            </div>
        </form>
        </div>
    </div>
...
<div class="container mt-4">
                        ...
                        <tbody>
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $student)
                                {
                                    ...
                                    <tr>
                                        <!-- <td><?= $student['id'] ?></td> -->
                                        <td><?= $student['location_rack_name'] ?></td>
                                        <td><?= $student['location_rack_status'] ?></td>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 422) {
						...
						$('#myTable').load("includes/home3.php" + " #myTable");
        ...
        $(document).on('click', '.editStudentBtn', function () {
            ...
            $.ajax({
                type: "GET",
                url: "includes/code2.php?student_id=" + student_id,
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#location_rack_name').val(res.data.location_rack_name);
                        $('#location_rack_status').val(res.data.location_rack_status);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#view_name').text(res.data.location_rack_name);
                        $('#view_email').text(res.data.location_rack_status);
