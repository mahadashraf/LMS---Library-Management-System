    ...
    <div class="modal-dialog">
        ...
        <form id="updateStudent">
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="">Author Status</label>
                    <input type="text" name="Author_status" id="Author_status" class="form-control" />
                </div>
                <!-- <div class="mb-3">
                    <label for="">Created On</label>
...
<div class="modal fade" id="studentViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">View Author</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
            <div class="modal-body">
...
<div class="container mt-4">
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 422) {
						...
						$('#myTable').load("includes/home2.php" + " #myTable");
        ...
        $(document).on('click', '.editStudentBtn', function () {
            ...
            $.ajax({
                type: "GET",
                url: "includes/code1.php?student_id=" + student_id,
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#Author_status').val(res.data.Author_status);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#view_name').text(res.data.Author_name);
                        $('#view_email').text(res.data.Author_status);
